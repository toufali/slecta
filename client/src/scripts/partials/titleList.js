...
const filterButton = document.querySelector('.list-actions .filter')
...
export default function init() {
  filterButton.addEventListener('click', handlePanel)
...
function togglePanel() {
  if (filterPanel.contains(document.activeElement)) filterButton.focus()
